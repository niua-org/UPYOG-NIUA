...
public final class IngestionRecordQueryBuilder {
    ...
    public static final String INSERT_INGESTION_DETAIL =
            ...
            "module_ingestion_id, module_detail_id, scheduler_id, tenant_id, module_name, push_date, request_data, " +
            "response_data, ingestion_status, exception_code, created_by, created_time, last_modified_by, last_modified_time) " +
            "VALUES (:moduleIngestionId, :moduleDetailId, :schedulerId, :tenantId, :moduleName, TO_DATE(:pushDate, '" + DashboardConstants.SQL_DATE_FORMAT + "'), :requestData::jsonb, :responseData::jsonb, :ingestionStatus, :exceptionCode, :createdBy, :createdTime, :lastModifiedBy, :lastModifiedTime)";

    public static final String INSERT_ADAPTER_INGESTION_ERROR_LOG =
            "INSERT INTO ug_adapter_ingestion_error_log (" +
