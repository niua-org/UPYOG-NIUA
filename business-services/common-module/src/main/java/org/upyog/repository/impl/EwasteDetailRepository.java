...
import org.upyog.repository.rowmapper.EwasteDetailsRowMapper;
import org.upyog.web.models.CommonDetails;

public class EwasteDetailRepository implements CommonDetailRepositoryInterface {
	...
	public CommonDetails findApplicationDetails(String applicationNumber) {
		 String query = "SELECT sv.APPLICATION_NO as applicationnumber, "
		        ...
		        return jdbcTemplate.queryForObject(query, new Object[]{applicationNumber}, new EwasteDetailsRowMapper());
