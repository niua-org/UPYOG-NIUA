...
public class SewerageEmp {
    ...
    private void searchByApplicationNo(WebDriver driver, WebDriverWait wait,
        ...
        js.executeScript("arguments[0].scrollIntoView({block:'center'});", sewerageInput);
        Thread.sleep(500);
    ...
    private void handleEditPageEmployee(WebDriver driver, WebDriverWait wait, JavascriptExecutor js)
        ...
        fillNumberInputH2(driver, wait, js,"Proposed Water closets", "2");
        fillNumberInputH2(driver, wait, js,"Proposed toilets", "2");

        // =========================
        // Connection Details
        // =========================

        fillNumberInputH2(driver, wait, js, "Number of Water Closets", "2");
        fillNumberInputH2(driver, wait, js, "Number of Toilet Seats", "2");
        ...
        fillInputH2(driver, wait, js,"Plumber License Number", "78987655446");
    ...
    private void handleActivateConnectionEmployee(WebDriver driver, WebDriverWait wait, JavascriptExecutor js)
        ...
        fillInputSecondH2(driver, wait, js,"Plumber License Number", "78987655446");
