...
//});
//
//// var delhi_state = new ol.layer.Image({
////             title: 'Delhi_Estates_Upadated',
////             // extent: [-180, -90, -180, 90],
////             source: new ol.source.ImageWMS({
////                 url: 'http://13.127.171.159:8080/geoserver/wms',
////                 params: {
////                     'LAYERS': 'LNEstates:Delhi_Estates_Upadated'
////                 },
////                 ratio: 1,
...
////overlays.getLayers().push(delhi_state);
//var popup = new Popup();
...
//
//                var url = "http://13.127.171.159:8080/geoserver/wfs?request=GetFeature&version=1.0.0&typeName=" + value_layer + "&outputFormat=json&cql_filter=INTERSECTS(the_geom," + wkt + ")";
//                //alert(url);
//
//
//                style = new ol.style.Style({
