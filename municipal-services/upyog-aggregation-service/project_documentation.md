...
|----------|----------------|-------------------|
| `QuickSummaryProvider` | 4 aggregate counts (apps, payments, completed, drafts) | `/egov-workflow-v2/egov-wf/process/dashboard/_count`, `/billing-service/bill/v2/_searchsummary` |
...
| `DueRenewalsProvider` | Bills/licences nearing expiry | `/billing-service/bill/v2/_searchsummary` |
