...
/**
 * Base user profile contract aligned with the eGov user service schema.
 * Holds identity, contact, address, roles, and audit fields; mapped to/from JSON with validation annotations.
 * Extended by OwnerInfo for property-linked garbage account owners.
 */
@Validated
