...
const ADSCitizenDetails = ({
  ...
  const [applicantName, setName] = useState(formData.applicant && formData.applicant[index] && formData.applicant[index].applicantName || formData?.applicant?.applicantName || value?.existingDataSet?.applicant?.applicantName || "");
  const [emailId, setEmail] = useState(formData.applicant && formData.applicant[index] && formData.applicant[index].emailId || formData?.applicant?.emailId || value?.existingDataSet?.applicant?.emailId || "");
  const [mobileNumber, setMobileNumber] = useState(formData.applicant && formData.applicant[index] && formData.applicant[index].mobileNumber || value?.existingDataSet?.applicant?.mobileNumber || formData?.applicant?.mobileNumber || user?.mobileNumber);
  const [alternateNumber, setAltMobileNumber] = useState(formData.applicant && formData.applicant[index] && formData.applicant[index].alternateNumber || formData?.applicant?.alternateNumber || value?.existingDataSet?.applicant?.alternateNumber || "");
