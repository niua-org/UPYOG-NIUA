...
function SelectDocument({
    ...
    return (
        <div className="border border-solid border-border bg-grey-light mb-lg" style={{ padding: "16px 8px 16px 8px", borderRadius: "5px", marginTop:"5px" }}>
            <div>
                <h1 className="text-text-primary font-bold" style={{ lineHeight: "37px", fontSize: "32px", fontFamily: "Roboto Condensed", paddingBottom: "24px" }}>{t(`BPA_${doc?.nocType}_HEADER`)}</h1>
                <div className="flex" style={{ paddingBottom: "24px" }}>
                    <h1 className="text-text-primary font-bold text-md" style={{ lineHeight: "19px", fontFamily: "Roboto", marginRight: "10px" }}>{t(`BPA_${doc?.nocType}_LABEL`)}</h1>
