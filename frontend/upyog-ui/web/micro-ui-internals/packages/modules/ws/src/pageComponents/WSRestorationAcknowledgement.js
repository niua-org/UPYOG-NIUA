...
const WSDisconnectAcknowledgement = () => {
  ...
  const handleDownloadPdf = () => {
    ...
    const PDFdata = getWSRestorationAcknowledgementData(disconnectionRes, disconnectionData?.property, disconnectionRes?.tenantId, t);
    PDFdata.then(res => Digit.Utils.pdf.generatev1(res));
  };
  return <Card className="ws-auto-142">
      <CardSectionHeader>
