...
import { CardSectionHeader, Modal, Row, StatusTable } from "@nudmcdgnpm/digit-ui-react-components";
        ...
        <Fragment>
            <div style={{ lineHeight: "19px", maxWidth: "950px", minWidth: "280px" }}>
                {wsAdditionalDetails?.additionalDetails?.isViewBreakup ? <div onClick={(e) => onPopupOpen()} style={{ marginTop: "12px" }}>
                    <span className="text-primary-main cursor-pointer">{t("WS_PAYMENT_VIEW_BREAKUP")}</span>
                </div> : null
                }
                {popup &&
                    <Modal
