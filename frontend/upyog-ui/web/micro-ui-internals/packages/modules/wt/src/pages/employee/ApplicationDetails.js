...
const ApplicationDetails = () => {
  ...
  const {
    ...
    error
  } = isWaterTanker ? Digit.Hooks.wt.useWTApplicationDetail(t, tenantId, bookingNo) : isTreePruning ? Digit.Hooks.wt.useTPApplicationDetail(t, tenantId, bookingNo) : Digit.Hooks.wt.useMTApplicationDetail(t, tenantId, bookingNo);
  ...
  const {
    ...
    error: updateError,
    mutate
  } = isWaterTanker ? Digit.Hooks.wt.useWTApplicationAction(tenantId) : isTreePruning ? Digit.Hooks.wt.useTPApplicationAction(tenantId) : Digit.Hooks.wt.useMTApplicationAction(tenantId);
  ...
  useEffect(() => {
    if (workflowDetails?.data?.applicationBusinessService && !(workflowDetails?.data?.applicationBusinessService === "watertanker" && businessService === "watertanker" || workflowDetails?.data?.applicationBusinessService === "mobileToilet" && businessService === "mobileToilet" || workflowDetails?.data?.applicationBusinessService === "treePruning" && businessService === "treePruning")) {
