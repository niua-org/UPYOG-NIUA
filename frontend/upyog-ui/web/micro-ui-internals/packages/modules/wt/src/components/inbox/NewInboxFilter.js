...
const Filter = ({
  ...
  const applyLocalFilters = () => {
    if (_searchParams.services.length === 0) onFilterChange({
      ..._searchParams,
      services: defaultSearchParams.services
  ...
  return <React.Fragment>
      <div className="filter">
        <div className="filter-card">
          <div className="heading wt-auto-15">
            <div className="filter-label wt-auto-16">
              <span>
              ...
              <span className="wt-auto-17">{t("ES_COMMON_FILTER_BY")}:</span>
            </div>
            <div className="clearAll" onClick={clearAll}>
              {t("ES_COMMON_CLEAR_ALL")}
            </div>
            {props.type === "desktop" && <span className="clear-search wt-auto-18" onClick={clearAll}>
          ...
          <div>
            ...
            <div>
              <div className="filter-label wt-auto-19">
                {t("ES_INBOX_LOCALITY")}:
              </div>
