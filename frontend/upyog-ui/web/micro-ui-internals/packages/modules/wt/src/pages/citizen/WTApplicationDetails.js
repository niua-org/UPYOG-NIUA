...
const WTApplicationDetails = () => {
  ...
  const getAcknowledgementData = async () => {
    ...
    const acknowldgementDataAPI = await getWTAcknowledgementData({
      ...applications
    }, tenantInfo, t);
  ...
  return <React.Fragment>
      <div>
        <div className="cardHeaderWithOptions wt-auto-66">
          <Header styles={{
          fontSize: "32px"
        }}>{t("WT_BOOKING_DETAILS")}</Header>
        ...
        <Card>
          ...
          <CardSubHeader className="wt-auto-67">{t("WT_APPLICANT_DETAILS")}</CardSubHeader>
          <StatusTable>
          ...
          <CardSubHeader className="wt-auto-68">{t("WT_ADDRESS_DETAILS")}</CardSubHeader>
            <StatusTable>
            ...
            <CardSubHeader className="wt-auto-69">{t("ES_REQUEST_DETAILS")}</CardSubHeader>
            <StatusTable>
