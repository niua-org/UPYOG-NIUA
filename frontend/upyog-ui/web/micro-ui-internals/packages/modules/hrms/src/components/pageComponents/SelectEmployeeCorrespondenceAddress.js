          ...
          <LabelFieldPair>
            ...
            <div className="field">
              <TextInput
                ...
                {...input.validation}
              />
               {currentValue&&currentValue.length>0&&!currentValue.match(Digit.Utils.getPattern('Address'))&&<CardLabelError className="text-md" style={{ width: "100%", marginTop: '-15px', marginBottom: '12px' }}>{t("CORE_COMMON_APPLICANT_ADDRESS_INVALID")}</CardLabelError>}
            </div>
          </LabelFieldPair>
        </React.Fragment>
      )})}
