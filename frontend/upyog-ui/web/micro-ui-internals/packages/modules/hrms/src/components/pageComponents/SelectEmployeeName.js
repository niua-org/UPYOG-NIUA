          ...
          <LabelFieldPair>
            ...
            <div className="field">
              <TextInput
                ...
                {...input.validation}
              />
            {currentValue&&currentValue.length>0&&!currentValue.match(Digit.Utils.getPattern('Name'))&&<CardLabelError className="text-md" style={{ width: "100%", marginTop: '-15px', marginBottom: '12px' }}>{t("CORE_COMMON_APPLICANT_NAME_INVALID")}</CardLabelError>}
            </div>
          </LabelFieldPair>
        </React.Fragment>
      )})}
