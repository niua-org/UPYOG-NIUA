...
import { Dropdown, RadioButtons, ActionBar, RemoveableTag, CloseSvg, CheckBox, Localities, SubmitBar, RefreshSVG } from "@nudmcdgnpm/digit-ui-react-components";
      ...
      <div className="filter">
        <div className="filter-card">
          <div className="heading items-center">
            <div className="filter-label flex items-center" style={{ marginTop:"auto" }}>
              <span>
              ...
              <span className="font-regular" style={{ marginLeft: "8px" }}>{t("UC_FILTERS_LABEL")}:</span>
            </div>
