      ...
      <div>
        <Card>
          <StatusTable style={{ padding: "10px 0px" }}>
            ...
            <hr className="border border-solid border-border" style={{ width: "35%", marginTop: "1rem", marginBottom: "1rem" }} />
          ...
          <div className="text-2xl font-bold" style={{ padding: "10px 0px" }}>{t("UC_SERVICE_DETAILS_LABEL")}</div>
          <StatusTable>
            <Row
          ...
          <div className="text-2xl font-bold" style={{ padding: "10px 0px" }}>{t("UC_CONSUMER_DETAILS_LABEL")}</div>
          <StatusTable>
