...
const NewAsset = ({
  ...
  const [assetDetails, setAssetDetails] = useState(formData.assetDetails && formData.assetDetails.assetParentCategory === formData?.asset?.assettype?.code ? formData.assetDetails : {
  ...
  if (Array.isArray(categoriesWiseData)) {
    ...
    formJson = categoriesWiseData.filter(category => {
  ...
  return <React.Fragment>
      ...
      <FormStep config={config} onSelect={goNext} onSkip={onSkip} t={t} isDisabled={!assetDetails["purchaseDate"] || !assetDetails["modeOfPossessionOrAcquisition"] || !assetDetails["purchaseOrderNumber"]}>
        <React.Fragment>
          <div>
            {`${t("AST_MODE_OF_POSSESSION_OR_ACQUISITION")}`} <span className="asset-auto-137">*</span>
            <div className="tooltip asset-auto-138">
              <InfoBannerIcon />
              <span className="tooltiptext asset-auto-139">
                {`${t("ASSET_ACQUISITION_METHOD")} `}
              </span>
            </div>
          </div>
          <Controller control={control} name={"modeOfPossessionOrAcquisition"} isMandatory={false} defaultValue={assetDetails["modeOfPossessionOrAcquisition"] ? assetDetails["modeOfPossessionOrAcquisition"] : ""} rules={{
          required: t("CORE_COMMON_REQUIRED_ERRMSG")
        }} render={props => <Dropdown className="form-field" selected={assetDetails["modeOfPossessionOrAcquisition"]} select={handleInputChange} option={dropDownData("ModeOfPossessionOrAcquisition")} optionKey="i18nKey" placeholder={"Select"} isMandatory={false} t={t} />} />
<div>
            {`${t("AST_PURCHASE_DATE")}`} <span className="asset-auto-140">*</span>
            <div className="tooltip asset-auto-141">
              <InfoBannerIcon />
              <span className="tooltiptext asset-auto-142">
                {`${t("ASSET_PURCHASE_DATE")}`} 
              </span>
            </div>
          </div>
         
          <TextInput t={t} type={"date"} isMandatory={false} optionKey="i18nKey" name={"purchaseDate"} value={assetDetails["purchaseDate"]} onChange={handleInputChange} max={new Date().toISOString().split("T")[0]} rules={{
          required: t("CORE_COMMON_REQUIRED_ERRMSG"),
          ...
          <TextInput t={t} type={"text"} isMandatory={false} optionKey="i18nKey" name="purchaseOrderNumber" value={assetDetails["purchaseOrderNumber"]} onChange={handleInputChange} {...validation = {
          isRequired: true,
          pattern: "^[a-zA-Z0-9/-]*$",
          type: "text",
          ...
          <div>
            ...
            <div className="tooltip asset-auto-147">
              <InfoBannerIcon />
              <span className="tooltiptext asset-auto-148">
                {`${t("ASSET_INVOICE_ISSUE_DATE")} `}
              </span>
            </div>
          </div>
          <TextInput t={t} key={assetDetails["purchaseDate"] || "no-purchase"} type={"date"} isMandatory={false} optionKey="i18nKey" name={"invoiceDate"} value={assetDetails["invoiceDate"]} onChange={handleInputChange} min={assetDetails["purchaseDate"] || ""}
        // max={new Date().toISOString().split("T")[0]}
        disabled={!assetDetails["purchaseDate"]} rules={{
          required: t("CORE_COMMON_REQUIRED_ERRMSG"),
          validDate: val => /^\d{4}-\d{2}-\d{2}$/.test(val) ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG"),
          validate: val => {
        ...
        <div>
            ...
            <div className="tooltip asset-auto-151">
              <InfoBannerIcon />
              <span className="tooltiptext asset-auto-152">
                {`${t("ASSET_INVOICE_ISSUE_DATE")} `}
              </span>
            </div>
          </div>
          <TextInput t={t} type={"text"} isMandatory={false} optionKey="i18nKey" name="invoiceNumber" value={assetDetails["invoiceNumber"]} onChange={handleInputChange} {...validation = {
          isRequired: true,
          pattern: "^[a-zA-Z0-9/-]*$",
          type: "text",
          title: t("PT_NAME_ERROR_MESSAGE")
...
<div>
            ...
            <div className="tooltip asset-auto-155">
              <InfoBannerIcon />
              <span className="tooltiptext asset-auto-156">
                {`${t("ASSET_USEFUL_LIFECYCLE")} `}
              </span>
            </div>
          </div>
          <TextInput t={t} type={"text"} isMandatory={false} optionKey="i18nKey" name="lifeOfAsset" value={assetDetails["lifeOfAsset"]} onChange={handleInputChange} {...validation = {
          isRequired: true,
        ...
        <div>
            ...
            <div className="tooltip asset-auto-159">
              <InfoBannerIcon />
              <span className="tooltiptext asset-auto-160">
                {`${t("ASSET_LOCATION_DETAILS")} `}
              </span>
            </div>
          </div>
          <div className="asset-auto-161">
                  <TextInput t={t} type={"text"} isMandatory={false} optionKey="i18nKey" name={"location"} value={assetDetails["location"] || ""} onChange={handleInputChange} ValidationRequired={false} {...validation = {
            isRequired: true,
            pattern: "^[-+]?([1-8]?\\d(\\.\\d+)?|90(\\.0+)?),\\s*[-+]?(180(\\.0+)?|((1[0-7]\\d)|([1-9]?\\d))(\\.\\d+)?)$",
            type: "text",
            title: t("VALID_LAT_LONG")
          }} className="asset-auto-162" />
                  <div className="butt-icon asset-auto-163" onClick={() => {
          ...
          <div>
            ...
            <div className="tooltip asset-auto-165">
              <InfoBannerIcon />
              <span className="tooltiptext asset-auto-166">
                {`${t("ASSET_PURCHASE_COST")} `}
              </span>
            </div>
          </div>
          <TextInput t={t} type={"number"} isMandatory={false} optionKey="i18nKey" name="purchaseCost" value={assetDetails["purchaseCost"]} onChange={handleInputChange} ValidationRequired={true} {...validation = {
          isRequired: true,
          pattern: regexPattern("number"),
          type: "number",
          title: t("PT_NAME_ERROR_MESSAGE")
        ...
        <div>
            ...
            <div className="tooltip asset-auto-169">
              <InfoBannerIcon />
              <span className="tooltiptext asset-auto-170">
                {`${t("ASSET_ACQUISITION_COST")} `}
              </span>
            </div>
          </div>
          <TextInput t={t} type={"text"} isMandatory={false} optionKey="i18nKey" name="acquisitionCost" value={assetDetails["acquisitionCost"]} onChange={handleInputChange} ValidationRequired={true} {...validation = {
          isRequired: true,
          pattern: regexPattern('number'),
          type: "number",
          title: t("PT_NAME_ERROR_MESSAGE")
...
<div>
            ...
            <div className="tooltip asset-auto-173">
              <InfoBannerIcon />
              <span className="tooltiptext asset-auto-174">
                {`${t("ASSET_BOOK_VALUE")} `}
              </span>
            </div>
          </div>
          <TextInput t={t} type={"text"} isMandatory={false} optionKey="i18nKey" name="bookValue" value={assetDetails["bookValue"]} onChange={handleInputChange} {...validation = {
          isRequired: true,
          pattern: "^[a-zA-Z0-9/-]*$",
          type: "text",
          title: t("PT_NAME_ERROR_MESSAGE")
          ...
          {formJson.map((row, index) => <div key={index}>
              ...
              <div>
                ...
                <div className="tooltip asset-auto-177">
                  <InfoBannerIcon />
                  <span className="tooltiptext asset-auto-178">
                    {`${t(row.code + "_INFO")} `}
                  </span>
                </div>
              </div>
          ...
          <TextInput t={t} type={"date"} isMandatory={false} optionKey="i18nKey" name={row.name} value={assetDetails[row.name]} onChange={handleInputChange} max={new Date().toISOString().split("T")[0]} rules={{
            required: t("CORE_COMMON_REQUIRED_ERRMSG"),
            validDate: val => /^\d{4}-\d{2}-\d{2}$/.test(val) ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG")
          }} className="asset-auto-179" /> : row.type == "dropdown" ?
          //  if dropdown render
          <Controller control={control} name={row.name} isMandatory={false} defaultValue={assetDetails[row.name] ? assetDetails[row.name] : ""} rules={{
            required: t("CORE_COMMON_REQUIRED_ERRMSG")
          }} render={props => <Dropdown className="form-field" selected={assetDetails[row.name]} select={handleInputChange} option={dropDownData(row.masterName)} optionKey="i18nKey" placeholder={"Select"} isMandatory={false} t={t} />} /> : row.addCurrentLocationButton === true ?
          // if Fetch Location True
          <div className="asset-auto-180">
                  <TextInput t={t} type={row.type} isMandatory={row.isMandatory} optionKey="i18nKey" name={row.name} value={assetDetails[row.name] || ""} onChange={handleInputChange} ValidationRequired={false} {...validation = {
              isRequired: true,
              pattern: regexPattern(row.columnType),
              type: row.columnType,
              title: t("VALID_LAT_LONG")
            }} className="asset-auto-181" />
                  <div className="butt-icon asset-auto-182" onClick={() => {
          ...
          <TextInput t={t} type={row.type} isMandatory={row.isMandatory} optionKey="i18nKey" name={row.name} value={assetDetails[row.name] || ""} onChange={handleInputChange} {...validation = {
            isRequired: row.isMandatory,
            pattern: regexPattern(row.columnType),
            type: row.columnType,
            title: t("PT_NAME_ERROR_MESSAGE")
          }} readOnly={row.isReadOnly} className="asset-auto-183" />}
            </div>)}
        </React.Fragment>
      </FormStep>
    </React.Fragment>;
