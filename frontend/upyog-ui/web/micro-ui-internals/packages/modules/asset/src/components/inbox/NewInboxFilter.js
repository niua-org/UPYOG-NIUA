  ...
  return <React.Fragment>
      <div className="filter">
        <div className="filter-card">
          <div className="heading asset-auto-27">
            <div className="filter-label asset-auto-28">
              <span>
              ...
              <span className="asset-auto-29">{t("ES_COMMON_FILTER_BY")}:</span>
            </div>
            <div className="clearAll" onClick={clearAll}>
              {t("ES_COMMON_CLEAR_ALL")}
            </div>
            {props.type === "desktop" && <span className="clear-search asset-auto-30" onClick={clearAll}>
          ...
          <div>
            ...
            <div>
              <div className="filter-label asset-auto-31">
                {t("ES_INBOX_LOCALITY")}:
              </div>
