        ...
        <div className="asset-auto-103">
            ...
            {comingDataFromAPI?.assetParentCategory === "IT" && <React.Fragment>
                    <LabelFieldPair>
                      ...
                      <div className="field">
                      <Controller control={control} name={"brand"} defaultValue={comingDataFromAPI?.additionalDetails?.brand} rules={{
                required: t("CORE_COMMON_REQUIRED_ERRMSG"),
                validate: {
                  pattern: val => /^[a-zA-Z/-]*$/.test(val) ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG")
                }
              }} render={props => <TextInput value={props.value} disable={false} autoFocus={focusIndex.index === editNewAssetDetails?.key && focusIndex.type === "brand"} onChange={e => {
                ...
                props.onBlur(e);
                  ...
                  <LabelFieldPair>
                    ...
                    <div className="field">
                    <Controller control={control} name={"invoiceDate"} defaultValue={comingDataFromAPI?.additionalDetails?.invoiceDate} rules={{
                required: t("CORE_COMMON_REQUIRED_ERRMSG"),
                ...
                <LabelFieldPair>
                      ...
                      <div className="field">
                      <Controller control={control} name={"manufacturer"} defaultValue={comingDataFromAPI?.additionalDetails?.manufacturer} rules={{
                required: t("CORE_COMMON_REQUIRED_ERRMSG"),
                validate: {
                  pattern: val => /^[a-zA-Z/-]*$/.test(val) ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG")
                }
              }} render={props => <TextInput value={props.value} disable={false} autoFocus={focusIndex.index === editNewAssetDetails?.key && focusIndex.type === "manufacturer"} onChange={e => {
                props.onChange(e.target.value);
                setFocusIndex({
                  index: editNewAssetDetails.key,
                  type: "manufacturer"
                ...
                props.onBlur(e);
                  ...
                  <LabelFieldPair>
                      ...
                      <div className="field">
                      <Controller control={control} name={"purchaseCost"} defaultValue={comingDataFromAPI?.additionalDetails?.purchaseCost} rules={{
                required: t("CORE_COMMON_REQUIRED_ERRMSG"),
                validate: {
                  pattern: val => /^[0-9]*$/.test(val) ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG")
                }
              }} render={props => <TextInput value={props.value} disable={false} autoFocus={focusIndex.index === editNewAssetDetails?.key && focusIndex.type === "purchaseCost"} onChange={e => {
                props.onChange(e.target.value);
                setFocusIndex({
                  index: editNewAssetDetails.key,
                  type: "purchaseCost"
                ...
                props.onBlur(e);
                  ...
                  <LabelFieldPair>
                      ...
                      <div className="field">
                      <Controller control={control} name={"purchaseOrderNumber"} defaultValue={comingDataFromAPI?.additionalDetails?.purchaseOrderNumber} rules={{
                required: t("CORE_COMMON_REQUIRED_ERRMSG"),
                validate: {
                  pattern: val => /^[a-zA-Z0-9/-]*$/.test(val) ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG")
                }
              }} render={props => <TextInput value={props.value} disable={false} autoFocus={focusIndex.index === editNewAssetDetails?.key && focusIndex.type === "purchaseOrderNumber"} onChange={e => {
                props.onChange(e.target.value);
                setFocusIndex({
                  index: editNewAssetDetails.key,
                ...
                props.onBlur(e);
                  ...
                  <LabelFieldPair>
                    ...
                    <div className="field">
                    <Controller control={control} name={"purchaseDate"} defaultValue={comingDataFromAPI?.additionalDetails?.purchaseDate} rules={{
                required: t("CORE_COMMON_REQUIRED_ERRMSG"),
                validDate: val => /^\d{4}-\d{2}-\d{2}$/.test(val) ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG")
              }} render={props => <TextInput type="date" value={props.value} onChange={e => {
                props.onChange(e.target.value);
                ...
                <LabelFieldPair>
                      ...
                      <div className="field">
                      <Controller control={control} name={"currentLocation"} defaultValue={comingDataFromAPI?.additionalDetails?.currentLocation} rules={{
                required: t("CORE_COMMON_REQUIRED_ERRMSG"),
                validate: {
                  pattern: val => /^[0-9]*$/.test(val) ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG")
                }
              }} render={props => <TextInput value={props.value} disable={true} autoFocus={focusIndex.index === editNewAssetDetails?.key && focusIndex.type === "currentLocation"} onChange={e => {
                props.onChange(e.target.value);
                setFocusIndex({
                  index: editNewAssetDetails.key,
                ...
                props.onBlur(e);
                  ...
                  <LabelFieldPair>
                      ...
                      <div className="field">
                      <Controller control={control} name={"assetAge"} defaultValue={comingDataFromAPI?.additionalDetails?.assetAge} render={props => <TextInput value={props.value} disable={false} autoFocus={focusIndex.index === editNewAssetDetails?.key && focusIndex.type === "assetAge"} onChange={e => {
                props.onChange(e.target.value);
                setFocusIndex({
                  index: editNewAssetDetails.key,
                  type: "assetAge"
                ...
                props.onBlur(e);
                  ...
                  <Controller control={control} name={"warranty"} defaultValue={comingDataFromAPI?.additionalDetails?.warranty} render={props => <Dropdown className="form-field" selected={props.value} select={props.onChange} onBlur={props.onBlur} disable={isEdit} option={warrantyTime} optionKey="i18nKey" t={t} />} />
                  </LabelFieldPair>
                  ...
                  <LabelFieldPair>
                      ...
                      <div className="field">
                      <Controller control={control} name={"pincode"} defaultValue={comingDataFromAPI?.addressDetails?.pincode} render={props => <TextInput value={props.value} disable={true} autoFocus={focusIndex.index === editNewAssetDetails?.key && focusIndex.type === "pincode"} onChange={e => {
                props.onChange(e.target.value);
                setFocusIndex({
                  index: editNewAssetDetails.key,
                  type: "pincode"
                ...
                props.onBlur(e);
                  ...
                  <LabelFieldPair>
                      ...
                      <div className="field">
                      <Controller control={control} name={"city"} defaultValue={comingDataFromAPI?.addressDetails?.city} rules={{
                required: t("CORE_COMMON_REQUIRED_ERRMSG"),
                validate: {
                  pattern: val => /^[a-zA-Z/-]*$/.test(val) ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG")
                }
              }} render={props => <TextInput value={props.value} disable={true} autoFocus={focusIndex.index === editNewAssetDetails?.key && focusIndex.type === "city"} onChange={e => {
                props.onChange(e.target.value);
                setFocusIndex({
                  index: editNewAssetDetails.key,
                  type: "city"
