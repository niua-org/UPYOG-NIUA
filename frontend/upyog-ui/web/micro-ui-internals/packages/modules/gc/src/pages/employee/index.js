 ...
 * 
 * Defines the routing structure for the GC employee-facing pages.
 * Sets up routes for:
 * - `inbox`: Employee task inbox with filtering and pagination
 * - `application-details`: Detailed view of a single application
 * - `search`: Search for applications by various criteria
 * - `new-application`: Create a new GC application
 * - `bills`: Placeholder for bills section
 * 
 * Includes breadcrumb navigation and redirects the root path to the inbox.
 */
            ...
            element={
              <PrivateRoute>
                <Inbox
                  ...
                  parentRoute={url}
                  isInbox={true}
                  filterComponent="GC_INBOX_FILTER"
                />
              </PrivateRoute>
            }
          />
