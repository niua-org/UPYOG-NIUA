...
import ESTDesktopInbox from "../../components/ESTDesktoInbox";
...
const Inbox = ({
  ...
  // const [Table, setTableConfig] = useState(() => Digit.ComponentRegistryService?.getComponent("ASTInboxTableConfig"));
  // const [getSearchFi]
