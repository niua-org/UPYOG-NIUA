    ...
    <div>
      ...
      <SearchForm onSubmit={onFilterSubmit} handleSubmit={handleSubmit}>
        <SearchField>
          ...
          <TextInput name="assetNumber" label="Enter Asset No." inputRef={register({})} />
        </SearchField>

        <SearchField>
          <label>{t("EST_BUILDING_NAME")}</label>
          <TextInput name="buildingName" label="Enter Building No." inputRef={register({})} />
        </SearchField>

        <SearchField>
          <label>{t("EST_LOCALITY")}</label>
          <TextInput name="locality" label="Enter locality"  inputRef={register({})} />
        </SearchField>
