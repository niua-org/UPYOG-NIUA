...
const SelectSpecialProofIdentity = ({
  ...
  return <React.Fragment>
      {window.location.href.includes("/citizen") ? window.location.href.includes("/citizen/pt/property/property-mutation") ? <Timeline currentStep={1} flow="PT_MUTATE" /> : <Timeline currentStep={3} /> : null}
      ...
      />
        ...
        {error ? <div className="pt-auto-92">{error}</div> : ""}
        <div className="pt-auto-93"></div>
      </FormStep>
    </React.Fragment>;
};
