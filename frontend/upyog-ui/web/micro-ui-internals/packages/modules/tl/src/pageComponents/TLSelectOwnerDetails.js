        ...
        <FormStep config={config} onSelect={goNext} onSkip={onSkip} t={t} isDisabled={false} forcedError={t(error)}>
          ...
          return <div key={`${field}-${index}`}>
                <div>
                  ...
                  <TextInput t={t} type={"text"} isMandatory={false} name="institutionName" value={field.institutionName} ValidationRequired={true} onChange={e => handleTextInputField(index, e, "institutionName")}
              ...
              {...{
                validation: {
                  ...
                  <Dropdown t={t} option={institutionOwnershipTypeOptions} selected={field.subOwnerShipCategory} select={value => {
                handleDropdownInputField(index, value, "subOwnerShipCategory");
                  ...
                  <TextInput t={t} type={"text"} isMandatory={false} name="name" value={field.name} onChange={e => handleTextInputField(index, e, "name")} ValidationRequired={true} {...{
                validation: {
                  // isRequired: true,
                  ...
                  <TextInput t={t} type={"text"} isMandatory={false} name="designation" value={field.designation} onChange={e => handleTextInputField(index, e, "designation")} ValidationRequired={true}
              //disable={isUpdateProperty || isEditProperty}
              {...{
                validation: {
                  // isRequired: true,
                  ...
                  <div className="field-container">
                    <span className="employee-card-input employee-card-input--front tl-auto-108">
                      +91
                    </span>
                ...
                {...{
                  ...
                  <div className="field-container">
                    <span className="employee-card-input employee-card-input--front tl-auto-109">
                      +91
                    </span>
                ...
                {...{
                  ...
                  <TextInput t={t} type={"text"} isMandatory={false} name="emailId" value={field?.emailId} onChange={e => handleTextInputField(index, e, "emailId")} ValidationRequired={true}
              //disable={isUpdateProperty || isEditProperty}
              {...{
                validation: {
                  // isRequired: true,
      ...
      <FormStep config={config} onSelect={goNext} onSkip={onSkip} t={t} isDisabled={typeOfOwner == "MULTIOWNER" ? formState?.length < 2 ? true : false : false} forcedError={t(error)}>
        ...
        return <div key={`${field}-${index}`}>
            ...
            background: "#FAFAFA"
                ...
                <CardLabel className="tl-auto-110">{`${t("TL_NEW_OWNER_DETAILS_NAME_LABEL")}`}<span className="check-page-link-button"> *</span></CardLabel>
                {typeOfOwner === "MULTIOWNER" && <LinkButton label={<div>
                        <span>
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="tl-auto-112">
            ...
            {...{
              validation: {
                ...
                {!isGenderLoading ? <RadioButtons t={t} options={TLmenu} optionsKey="i18nKey" name={`gender-${index}`} selectedOption={field.gender} onSelect={e => handleRadioButtonInput(index, e, "gender")} labelKey="" isPTFlow={true}
            //disabled={isUpdateProperty || isEditProperty}
            /> : <Loader />}
                <CardLabel>{`${t("TL_MOBILE_NUMBER_LABEL")}`}<span className="check-page-link-button"> *</span></CardLabel>
                <div className="field-container">
                  <span className="employee-card-input employee-card-input--front tl-auto-113">
                    +91
                  </span>
                  <TextInput style={typeOfOwner === "MULTIOWNER" ? {
                background: "#FAFAFA",
                ...
                maxWidth: "500px"
              }} type={"text"} t={t} isMandatory={false} optionKey="i18nKey" name="mobilenumber" value={field.mobilenumber} onChange={e => handleTextInputField(index, e, "mobilenumber")} ValidationRequired={true}
              //disable={isUpdateProperty || isEditProperty}
              {...{
                validation: {
                  isRequired: true,
            ...
            {...{
              validation: {
                ...
                <RadioButtons t={t} options={relationshipMenu} optionsKey="i18nKey" name={`relationship-${index}`} value={field.relationship} selectedOption={field.relationship} onSelect={e => handleRadioButtonInput(index, e, "relationship")} labelKey="" isPTFlow={true} />
                <CardLabel>{`${t("NOC_APPLICANT_EMAIL_LABEL")}`}</CardLabel>
                <div>
                  <TextInput t={t} type={"text"} isMandatory={false} name="emailId" value={field?.emailId} onChange={e => handleEmailChange(index, e, "emailId")} ValidationRequired={true}
              //disable={isUpdateProperty || isEditProperty}
              />
                  {error && <span className="tl-auto-114">{error}</span>}
                  </div>
                {typeOfOwner === "MULTIOWNER" && <CheckBox label={t("TL_PRIMARY_OWNER_LABEL")} onChange={e => dispatch({
