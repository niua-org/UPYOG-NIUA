...
const ArrowDown = ({ className, onClick, styles, disable }) => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill={disable ? "var(--grey-dark)" : "var(--black)"}
    className={className}
    onClick={onClick}
    width="18px"
    height="18px"
...
const Phone = ({ className, fillcolor, style }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill={fillcolor ? fillcolor : "var(--primary-main)"}
    viewBox="0 0 24 24"
    style={style ? style : {}}
    className={className}
  >
...
const Close = ({ className, style }) => (
  <svg style={{ ...style }} focusable="false" viewBox="0 0 24 24" aria-hidden="true" width="24" height="24" fill="var(--grey-dark)" className={className}>
...
const UpwardArrow = ({ color = "var(--success)", rotate = 0, marginRight = 0 }) => (
  <svg
...
const PrimaryDownlaodIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="var(--primary-main)">
    <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" />
  </svg>
);
...
const ComplaintIcon = ({ className, styles }) => (
  <svg style={{ ...styles }} className={className} viewBox="0 0 48 48" fill="var(--primary-main)" xmlns="http://www.w3.org/2000/svg">
...
const CHBIcon=({styles, className})=>(
  <svg width="24" height="24" className={className} style={{ ...styles }} viewBox="0 0 24 24" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
