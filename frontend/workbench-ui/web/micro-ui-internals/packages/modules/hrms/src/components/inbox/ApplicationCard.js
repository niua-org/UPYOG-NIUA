...
import { Card, DetailsCard, Loader, PopUp, SearchAction } from "@upyog/workbench-ui-react-components";
import { FilterAction } from "@upyog/workbench-ui-react-components";
  ...
  if (!data || data?.length === 0) {
    ...
    result = (
      <DetailsCard
        ...
        linkPrefix={linkPrefix ? linkPrefix : DSO ?  `/workbench-ui/employee/fsm/application-details/` : `/workbench-ui/employee/fsm/`}
      />
    );
  }
