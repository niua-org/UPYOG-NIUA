...
import { Card, Banner, CardText, SubmitBar, Loader, LinkButton, ActionBar } from "@upyog/workbench-ui-react-components";
...
const Response = (props) => {
  ...
  return (
    <Card>
      ...
      <ActionBar>
        <Link to={`${props.parentRoute.includes("employee") ?  `/workbench-ui/employee` :  `/workbench-ui/citizen`}`}>
