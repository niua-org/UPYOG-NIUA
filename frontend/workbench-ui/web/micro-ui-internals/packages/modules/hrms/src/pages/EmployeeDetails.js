import { ActionBar, Card, CardSubHeader, DocumentSVG, Header, Loader, Menu, Row, StatusTable, SubmitBar } from "@upyog/workbench-ui-react-components";
  ...
  useEffect(() => {
    switch (selectedAction) {
      ...
      case "COMMON_EDIT_EMPLOYEE_HEADER":
        return navigate(`/${window?.contextPath}/employee/hrms/edit/${tenantId}/${employeeId}`);
      default:
        break;
    }
  }, [selectedAction]);
