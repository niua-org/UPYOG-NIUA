...
import { EmployeeModuleCard } from "@upyog/workbench-ui-react-components";
...
const PGRCard = () => {
  ...
  const allLinks = [
    { text: t("ES_PGR_INBOX"), link: `/workbench-ui/employee/pgr/inbox` },
    { text: t("ES_PGR_NEW_COMPLAINT"), link: `/workbench-ui/employee/pgr/complaint/create`, accessTo: ["CSR"] },
  ];
  ...
  let propsForCSR =[
    {
      ...
      link: `/workbench-ui/employee/pgr/complaint/create`,
      role: "CSR"
    }
  ]
  ...
  const propsForModuleCard = {
    ...
    kpis: [
        {
            label: t("TOTAL_PGR"),
            link: `/workbench-ui/employee/pgr/inbox`
        },
        {
