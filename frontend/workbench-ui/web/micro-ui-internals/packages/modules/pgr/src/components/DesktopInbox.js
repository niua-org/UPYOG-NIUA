...
import { Card, Loader } from "@upyog/workbench-ui-react-components";
    ...
    () => [
      {
        ...
        Cell: ({ row }) => {
          return (
            <div>
              <span className="link">
                <Link to={`/workbench-ui/employee/pgr/complaint/details/` + row.original["serviceRequestId"]}>{row.original["serviceRequestId"]}</Link>
              </span>
